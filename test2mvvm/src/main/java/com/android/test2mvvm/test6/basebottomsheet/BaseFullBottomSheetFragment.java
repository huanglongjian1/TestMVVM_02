...
public class BaseFullBottomSheetFragment extends BottomSheetDialogFragment {
    ...
    public void onStart() {
        ...
        // FrameLayout bottomSheet1 = dialog.getDelegate().findViewById(com.google.android.material.R.id.design_bottom_sheet);
        FrameLayout bottomSheet = (FrameLayout) getView().getParent();
        if (bottomSheet != null) {
